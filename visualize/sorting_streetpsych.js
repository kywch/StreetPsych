...
Demo.prototype.initPictures = function (pictureData, srcUrl) {
    ...
    for (var ii = 0; ii < pictureData.length; ii++) {
        ...
        imageSrc.title = pictureData[ii].name + ' --> ' +
            ...
            'PR: ' + pictureData[ii].preference.toFixed(2).toString() + '; ' +
            ...
            'DO: ' + pictureData[ii].disorder.toFixed(2).toString();
        ...
        item.setAttribute('data-preference', pictureData[ii].preference);
        ...
        item.setAttribute('data-disorder', pictureData[ii].disorder);
