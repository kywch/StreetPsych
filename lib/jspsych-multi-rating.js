...
jsPsych.plugins['multi-rating-trial'] = (function () {

  jsPsych.pluginAPI.registerPreload('multi-rating-trial', 'stimuli', 'image');

  var plugin = {};

  plugin.info = {
    name: 'multi-rating-trial',
    description: '',
    parameters: {
      prompt_header: {
  ...
  plugin.trial = function (display_element, trial) {
    ...
    display_element.innerHTML = plugin.generate_stimulus(trial.prompt_header, trial.prompt_footer,
      trial.stimuli, trial.image_array, trial.image_size);
  ...
  plugin.generate_stimulus = function (prompt_header, prompt_footer, pattern, image_array, image_size) {
    ...
    html += '<td style="width:282px;height:55px"><div id="jspsych-multi-rating-trash" ' +
      ...
      '<img src="https://abzfzjuien.cloudimg.io/height/55/x/https://users.rcc.uchicago.edu/~kywch/FIRE_201901/trashcan2.png"></div></td>';
    //      '<img src="https://users.rcc.uchicago.edu/~kywch/FIRE_201901/trashcan.png" height="55px" align="middle"></div></td>';
